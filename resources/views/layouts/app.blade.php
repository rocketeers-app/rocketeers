          ...
          <div class="pt-5 bg-gray-900 md:pt-10">
            <nav class="relative flex items-center justify-between px-4 mx-auto max-w-7xl sm:px-6" aria-label="Global">
              ...
              <div class="hidden md:flex md:items-center md:space-x-6">
                <a href="https://rocketeers.app" class="text-base font-medium text-white hover:text-gray-300">
                  Login
          ...
          <div class="absolute inset-x-0 top-0 z-10 p-2 transition origin-top transform md:hidden"
            ...
            <div class="overflow-hidden bg-gray-800 rounded-lg shadow-md ring-1 ring-black ring-opacity-5">
              <div class="flex items-center justify-between px-5 pt-4">
                ...
                <div class="-mr-2">
                  <button type="button" class="inline-flex items-center justify-center p-2 text-gray-800 bg-gray-600 rounded-md hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-600"
                  @click="menu = false">
              ...
              <div class="pt-5 pb-6">
                ...
                <div class="px-5 mt-6">
                  <a href="https://rocketeers.app" class="block w-full px-4 py-3 font-medium text-center text-white bg-green-400 rounded-md shadow hover:bg-green-500">Login <span class="px-2 py-1 ml-1 text-sm bg-green-600 rounded">BETA</span></a>
                </div>
              </div>
            </div>
          </div>
