...
@section('main')
    <div class="max-w-screen-md mx-auto">
        <div class="max-w-xl mx-auto text-center">
            ...
            <h1 class="mb-4 text-2xl font-extrabold leading-tight text-white md:text-5xl">Sites management for Developers</h1>
            <div class="my-10 mb-10 text-xl leading-relaxed text-gray-200">
                <p>Increasingly more developers are offering their clients an full-service with development services and also hosting the online product.</p>
            </div>
        </div>
