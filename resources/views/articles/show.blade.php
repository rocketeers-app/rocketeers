...
>
    <div class="max-w-screen-md mx-auto">
        <div class="max-w-xl mx-auto text-center">
            ...
            <h1 class="mb-4 text-2xl font-extrabold leading-tight text-white md:text-5xl">{{ $article->pageTitle }}</h1>
        ...
        @else
            <div class="p-16 text-center border-gray-800 border-y-4 mt-14">
                ...
                <form action="/subscribe" method="post" class="relative max-w-lg mx-auto mt-1 md:mt-4">
                    ...
                    <input id="email" type="email" name="email" class="block bg-white w-full py-4 pl-5 text-base text-gray-900 placeholder-gray-500 border border-transparent rounded-md shadow-sm pr-[140px] sm:pr-[180px] focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-emerald-600" placeholder="Email address" required>
        ...
        <h4 class="mt-10 mb-10 text-2xl font-extrabold leading-tight text-gray-200 md:mt-20 sm:text-4xl">Related articles</h4>
