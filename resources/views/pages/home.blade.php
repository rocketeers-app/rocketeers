    ...
    <main class="container max-w-screen-md pt-5 mx-auto md:pt-10">
        ...
        <div class="px-4">
            <form action="#" class="relative max-w-lg mx-auto mt-1 md:mt-4">
                ...
                <input id="email" type="email" name="email" class="block w-full py-4 pl-5 text-base text-gray-900 placeholder-gray-500 border border-transparent rounded-md shadow-sm pr-[140px] sm:pr-[180px] focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-green-600" placeholder="Email address">
